...
Feature: Native payment for regular product, address delivery, PayPal
...
Scenario: Native payment for regular product
	...
	When I see module "Bezorgen"
		...
		And I see module "Betalen"
			And I select "Paypal" from dropdown options
			And I see information text about PayPal payment
		...
		And I am redirected to PayPal environment (app or website)
			And I follow steps to pay via PayPal
			And the payment is successful
			And I am redirected back to the Bijenkorf app
		And I see Webview with payment confirmation
	Then I have successfully executed native payment for regular product via PayPal